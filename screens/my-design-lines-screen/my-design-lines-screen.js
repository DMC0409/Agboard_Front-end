...
import { styles } from "./my-design-lines-screen.styles";
...
// 当前页面的route name
const SOURCE_SCREEN_NAME = 'ScreenContentForDesign'
...
const ScreenContent = ({ route, navigation, userID, boardType, boardAngel }) => {
    ...
    return (
        <View style={styles.box}>
            {/* 年月日 */}
            <View style={{ paddingTop: 8, paddingHorizontal: 15, backgroundColor: '#fff' }}>
                <ButtonGroup
                    buttons={['全部', '年', '月', '日']}
...
// 视图主组件
const MyDesignLinesScreen = ({ navigation, boardType }) => {
    // 岩板标签数组
