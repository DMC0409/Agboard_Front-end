...
import { styles } from "./board-type-setting-screen.styles";
...
// 视图主组件
const BoardTypeSettingScreen = ({ navigation, userID, currentBoardType, currentAngelType, updateBoardSettingType }) => {
    // 当前选中显示的icon
